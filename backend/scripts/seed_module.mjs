...
let config = {};
if (process.env.SEED_MODULE_CONFIG_JSON) {
  try { config = JSON.parse(process.env.SEED_MODULE_CONFIG_JSON); }
  catch { console.error('SEED_MODULE_CONFIG_JSON must be valid JSON'); process.exit(1); }
}
