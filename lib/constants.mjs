...
// Official pre-generated $FEES mint address. This address is pinned before the
// mint account is created on mainnet. BUYBACK_ENABLED must remain false until
// the mint account exists and the production swap + signer path is canary-verified.
export const FEES_MINT_ADDRESS = 'CiWvzc7MkUXSVusAckPvqZ9A5cMzQ44gpfje1ZibFEES';
